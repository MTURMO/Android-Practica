...
public class WishProductFragmentFriend extends Fragment{

    private ArrayList<Product> products;
    private ArrayList<Gift> gifts;
    private GiftAdapterFriend adapter;
    ...
    private void parsear(JSONObject response) {
        ...
        try {
            ...
            for (int i = 0; i < giftsArray.length(); i++) {
                ...
                apiCalls.getProductByIDForFriend(accessToken, number, getContext());
                apiCalls.getGiftByIdForFriend(accessToken, giftObject.getInt("id"), getContext());
            }
